package trackinlogic.trans.pss.com.trackinlogic.features.logsheet;
...
public class LogSheetActivity extends NavigationMenu implements View.OnClickListener {
    ...
    @BindView(R.id.sleepDutyStartTime)
    public EditText edtSleepBirthStartTime;
    @BindView(R.id.sleepDutyEndTime)
    public EditText edtSleepBirthEndTime;
    @BindView(R.id.drivingDutyStartTime)
    public EditText edtDrivingDutyStartTime;
    @BindView(R.id.drivingDutyEndTime)
    public EditText edtDrivingDutyEndTime;
    @BindView(R.id.onDutyStartTime)
    public EditText edtOnDutyStartTime;
    @BindView(R.id.onDutyEndTime)
    public EditText edtOnDutyEndTime;
