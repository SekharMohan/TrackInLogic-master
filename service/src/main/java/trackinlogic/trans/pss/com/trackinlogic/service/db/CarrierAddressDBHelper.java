...
public class CarrierAddressDBHelper extends SQLiteOpenHelper {

    public static final String DATABASE_NAME = "Trackin.db";
    public static final String CONTACTS_TABLE_NAME = "carrieraddress";
    ...
    public CarrierAddressDBHelper(Context context, Scheduler ioScheduler) {
    ...
    public Observable<Boolean> insertContact( String name, String country, String state, String street, String city, int zip) {
